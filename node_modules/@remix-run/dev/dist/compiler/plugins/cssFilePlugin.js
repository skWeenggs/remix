    ...
    async setup(build) {
      ...
      build.onLoad({
        ...
        let {
          ...
          warnings,
          errors
        } = await esbuild__default["default"].build({ ...buildOps,
        ...
        let outputFilesWithoutEntry = outputFiles.filter(file => file !== entryFile); // write all assets
