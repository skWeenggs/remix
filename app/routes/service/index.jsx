            ...
            <div class='h-full w-full  bg-no-repeat bg-center bg-cover bg-portfolio'>
                    ...
                    <section class='lg:h-[320px]  lg:max-w-[990px] block m-auto'>
                      <div class='lg:h-[320px] m-auto flex text-center flex-col justify-center'>
                        <h1 class='text-2xl pt-10 lg:text-5xl md:text-5xl  2xl:text-7xl text-center  text-[#ffffff] z-30'>{props.heading}</h1>
                        <div class='text-center mb-10  font-md text-sm lg:text-sm  2xl:text-lg text-[#cbcaca]  m-5' style={{letterSpacing:'2px'}}>
                 ...
                 <div class='bg-[#fff] opacity-90 z-0 lg:py-10 p-10 flex'>
                    <section class='lg:h-[320px] my-10 lg:max-w-[990px] block m-auto'>
                      <div class='lg:h-[320px] m-auto flex text-center 	font-weight: 400; flex-col justify-center'>                      
                            {props.postdata.map((item)=> <div class='text-center my-5 font-weight: 500 font-md text-sm 2xl:text-lg  m-5'>{item} </div>)}
                      </div>
                    </section>
                 </div>
                    ...
                    <section class='lg:max-w-[1140px] block m-auto'>
                     <div class='w-full md:flex lg:flex text-xl '>
                      <div class='lg:pt-20  lg:w-3/6 md:w-3/6  w-full'>
                       <h1 class='text-[#999999] text-sm  2xl:text-lg	font-weight: 400 uppercase '>{props.apptype}</h1>
                       <h1 class='text-[#bf1e2e] text-md md:text-4xl  2xl:text-5xl  mb-5'>{props.servicetype}</h1>
                       <ul class='py-5 text-[#595959]'>
                       <div class='mb-10 font-md text-sm font-weight: 400 text-[#595959] xl:text-md 2xl:text-2xl' >
                        {props.sdesc}
                          </div>
                           ...
                           return(
                            <>
                              ...
                              <i class="fa m-1 text-[#23a455]">&#xf087;</i>
                                <div class='ml-2'>
                                  <h1 class='mb-2 text-base xl:text-md 2xl:text-2xl '>{item.head}</h1>
                                </div>
                              </li >
                            </>
                           )
                 ...
                 <div class='bg-[#fff] p-10'>
                    <section class='lg:max-w-[1140px] block m-auto'>
                     <div class='w-full md:flex lg:flex text-xl '>
                      <div class='lg:pt-20  lg:w-3/6 md:w-3/6  w-full'>
                       <h1 class='text-[#999999] text-sm 	font-weight: 400  2xl:text-2xl '>WHY CHOOSE WEENGGS FOR YOUR</h1>
                       ...
                       <ul class='py-5 text-[#595959]  text-sm	font-weight: 400 '>
                        ...
                        {props.data1.map((item,index)=>{
                            ...
                            <i class={item.logo} />
                            <div class='ml-2'>
                            <h1 class='mb-2 text-base 2xl:text-2xl'>{item.head}</h1>
                            </div>
                            </li >
                            )
                          })}
