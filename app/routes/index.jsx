       ...
       <div className='bg-[#060606] opacity-70  flex'>
		<section className='h-[100vh] justify-center items-center  max-w-[1140px] flex m-auto'>
          <div className=' text-center  '>
            <h1 className='text-2xl font-sans lg:text-4xl md:text-4xl mb-10 xl:text-4xl 2xl:text-4xl  text-[#ffffff]'>The epicenter where latest technology meets creativity!</h1>
