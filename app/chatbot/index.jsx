        ...
        <div className="p-5 text-sm  text-white ">
         ...
         <form className="w-full max-w-sm p-5 bg-[#fafafa] border-l-4 border-red-500 rounded"  onSubmit={handleSubmit}>
                ...
                <div className="relative z-0 mb-6 w-full group text-xs">
                    ...
                    <div style={{color:'red'}} id="massage-error" className="error"></div>
                </div>

            <div className="md:flex md:items-center">
               
                <button type="submit" className="inline-block px-6 py-2.5 w-full bg-red-600 text-white font-medium text-sm  uppercase rounded shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out"> <i className="fa fa-paper-plane rotate-45 m-2 "></i> Submit</button>
            </div>
